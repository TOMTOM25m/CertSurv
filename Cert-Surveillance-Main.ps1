...
.DESCRIPTION
    [DE] Ein minimalistisches PowerShell-Skript zur Ueberwachung von SSL/TLS-Zertifikaten nach Regelwerk v9.6.0.
    ...
    [EN] A minimalistic PowerShell script for SSL/TLS certificate monitoring according to Rulebook v9.6.0.
